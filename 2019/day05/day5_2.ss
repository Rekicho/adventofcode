                ...
                (if (not (= opcode 99))
                    (begin
                      (cond
                        ...
                        ((= opcode 5) (if (not (zero? (vector-ref vetor (if (zero? param1) (vector-ref vetor (+ i 1)) (+ i 1))))) (set! i (vector-ref vetor (if (zero? param2) (vector-ref vetor (+ i 2)) (+ i 2)))) (set! i (+ i 3))))
                        ((= opcode 6) (if (zero? (vector-ref vetor (if (zero? param1) (vector-ref vetor (+ i 1)) (+ i 1)))) (set! i (vector-ref vetor (if (zero? param2) (vector-ref vetor (+ i 2)) (+ i 2)))) (set! i (+ i 3))))
                        ((= opcode 7) (begin (vector-set! vetor (if (zero? param3) (vector-ref vetor (+ i 3)) (+ i 3)) (if (< (vector-ref vetor (if (zero? param1) (vector-ref vetor (+ i 1)) (+ i 1))) (vector-ref vetor (if (zero? param2) (vector-ref vetor (+ i 2)) (+ i 2)))) 1 0)) (set! i (+ i 4))))
                        ((= opcode 8) (begin (vector-set! vetor (if (zero? param3) (vector-ref vetor (+ i 3)) (+ i 3)) (if (= (vector-ref vetor (if (zero? param1) (vector-ref vetor (+ i 1)) (+ i 1))) (vector-ref vetor (if (zero? param2) (vector-ref vetor (+ i 2)) (+ i 2)))) 1 0)) (set! i (+ i 4)))))
                      (percorre vetor i)))))))
    (lambda ()
